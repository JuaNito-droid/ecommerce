...
function Footer() {
  return (
    <footer className="bg-midnight-blue text-gray-300 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/contact" className="hover:text-red-400 transition">Contacto</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-red-400 transition"><i className="fab fa-facebook-f text-2xl"></i></a>
              <a href="#" className="hover:text-red-400 transition"><i className="fab fa-twitter text-2xl"></i></a>
              <a href="#" className="hover:text-red-400 transition"><i className="fab fa-instagram text-2xl"></i></a>
              <a href="#" className="hover:text-red-400 transition"><i className="fab fa-linkedin-in text-2xl"></i></a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Silicom. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
