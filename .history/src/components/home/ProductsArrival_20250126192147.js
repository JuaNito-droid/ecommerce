...
function ProductsArrival({ data, isAuthenticated }) {
  ...
  const renderProduct = (product) => (
    <div
      key={product.id}
      className="group relative m-4 border border-gray-300 p-4 rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105"
    >
      <div className="w-full bg-gray-200 aspect-w-1 aspect-h-1 rounded-md overflow-hidden lg:h-52 lg:aspect-none">
        <img
