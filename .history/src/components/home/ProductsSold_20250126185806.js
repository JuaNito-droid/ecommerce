  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 -mt-28">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5 sm:gap-6 lg:gap-8">
          {data?.map((product) => (
            <div key={product.id} className="group relative border border-gray-300 p-4 rounded-lg overflow-hidden">
              <div className="relative w-full h-52 sm:h-auto sm:aspect-w-2 sm:aspect-h-3">
                <img
                  src={product.photo}
                  alt={product.name}
