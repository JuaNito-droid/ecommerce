...
function Product() {
  ...
  return (
    <div className="flex flex-wrap justify-center md:px-20 bg-white pb-24 pt-4">
      ...
      <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/3 mb-5">
      <div
  className={`relative group ${isSpinning ? "animate-spin" : ""}`} // Mantiene el giro si está activo
  onClick={handleCogClick}
>
  {/* Contenedor del borde */}
  <div className="p-2 rounded-full border-2 border-transparent group-hover:border-crimson-red transition-all duration-300">
    {/* Ícono */}
