...
function ProductsArrival({ data, isAuthenticated }) {
  ...
  const settings = {
    ...
    responsive: [
      ...
      { breakpoint: 640, settings: { slidesToShow: 1 } }, // Ajustar para pantallas más pequeñas
    ],
  };
    ...
    <div className="bg-white">
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="py-8 w-full">
          <h2
            ref={headingRef}
            className="text-2xl font-extrabold tracking-tight text-gray-900 text-center md:text-left w-full"
          >
            Productos nuevos
          </h2>
