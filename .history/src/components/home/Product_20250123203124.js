...
function Product() {
  ...
  return (
    <div className="flex flex-wrap justify-center md:px-20 bg-white pb-24 pt-4">
      ...
      <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/3 mb-5">
        <div className="relative group">
          <CloudUploadIcon className="h-12 w-12 text-gray-700 transition-transform duration-500 group-hover:stroke-crimson-red group-hover:rotate-355" />
        </div>
        <h3 className="text-xl font-semibold text-gray-900 mt-4">
      ...
      <div className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/3 mb-5">
        ...
        >
          <CogIcon className="h-12 w-12 text-gray-700 transition-transform duration-500 group-hover:stroke-crimson-red group-hover:rotate-360" />
        </div>
        <h3 className="text-xl font-semibold text-gray-900 mt-4">
          Cómo comprar online
        </h3>
