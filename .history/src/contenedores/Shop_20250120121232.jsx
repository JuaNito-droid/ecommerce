                 ...
                 {categories && Object.entries(
                  ...
                  groupedCategories.length > 1 ? (
                    <li key={firstWord} className="relative group">
                      ...
                      {/* Menú desplegable con mejoras para que sea visible al pasar el cursor */}
                      <ul className="absolute left-0 w-full bg-red-500 border border-gray-200 shadow-md rounded-md z-10 hidden group-hover:block group-hover:opacity-100 group-hover:scale-100 opacity-0 scale-95 transition-all duration-300 ease-in-out">
                        {groupedCategories.map(category => (
                          <li key={category.id} className="px-12 py-12 hover:bg-gray-100">
                            <input
                              name="category_id"
                              type="radio"
                              value={category.id}
                              ...
                              onChange={onChange}
                            />
                            <label className="ml-12 text-gray-500">{category.name}</label>
                          </li>
                        ))}
                      </ul>
                    </li>
