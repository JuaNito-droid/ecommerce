...
function ContactUs() {
  ...
  return (
    <>
      ...
      <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 inline-block relative">
  <span className="relative z-10">Nuestras Sucursales</span>
  <span className="absolute left-0 bottom-0 block h-1 bg-red-400" style={{ width: '100%' }}></span>
  <span
    className="absolute left-0 bottom-0 block h-1 bg-gray-500 transition-transform origin-left duration-500"
