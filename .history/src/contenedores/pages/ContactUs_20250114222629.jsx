...
function ContactUs() {
  ...
  useEffect(() => {
    const text = "Nuestras Sucursales"; // Texto del H2
    const maxLength = 50; // Longitud máxima que queremos considerar
    const calculatedWidth = Math.min((text.length / maxLength) * 100, 100); // Calcula el porcentaje
