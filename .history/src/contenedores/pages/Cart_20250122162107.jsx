...
import WishlistItem from "../../componentes/cart/WishlistItem";
...
const Cart = ({
    ...
    useEffect(() => {
        ...
        get_total()
        get_item_total()
    }, [get_items, get_total, get_item_total])
    ...
    return (
      ...
      <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Artículos en carrito ({total_items})</h1>
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">30.00bs</dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">48.30Bs</dd>
              </div>

              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                <dt className="text-base font-medium text-gray-900">Total del pedido</dt>
                <dd className="text-base font-medium text-gray-900">{amount.toFixed(2)}Bsss</dd>
              </div>
            </dl>
