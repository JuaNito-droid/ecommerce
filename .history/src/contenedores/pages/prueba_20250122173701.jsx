...
import ImageGallery from "../../componentes/product/ImageGallery";
import WishlistHeart from "../../componentes/product/WishlistHeart";
import { Navigate } from "react-router";

import Stars from '../../componentes/product/Stars'
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-3">
              ...
              <p className={`text-2xl ${isAuthenticated ? "font-medium text-gray-900" : "text-red-500"}`}>
                  {isAuthenticated ? `${product && product.price}Bs` : "."}
                </p>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 flex sm:flex-col1">
                {loading?<button 
                  className="max-w-xs flex-1 bg-midnight-blue border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-purple-night focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full">
                    <Oval
                    color="#fff"
                    width={20}
                    height={20}/>
            ...
            <div className="grid grid-cols-5">
                  <div className="col-span-2">
                    ...
                    </div>
                    {
                      ...
                      <button
                        type="submit"
                        className="mt-4  inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-midnight-blue hover:bg-purple-night focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                        Actualizar
                      </button>
                      </form>:
