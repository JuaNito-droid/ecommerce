...
function ContactUs() {
  ...
  useEffect(() => {
    if (titleRef.current) {
      setBarWidth(titleRef.current.offsetWidth); // Calcula el ancho del texto
    }
  }, []);
  ...
  return (
    <>
      ...
      <div className="px-16 py-12">
        ...
        <div className="w-full h-2 bg-gray-300 mt-2 mb-14 relative">
          <div
            className="h-full bg-red-500"
            style={{ width: `${barWidth}px` }} // Aplica el ancho dinámico
          ></div>
        </div>
