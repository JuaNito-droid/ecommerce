  ...
  {categories && Object.entries(
    ...
    groupedCategories.length > 1 ? (
      <li key={firstWord} className="relative group">
        ...
        <ul className="absolute left-full top-0 ml-2 bg-red-500 border border-gray-200 shadow-md rounded-md z-10 hidden group-hover:block group-hover:opacity-100 group-hover:scale-100 opacity-0 scale-95 transition-all duration-300 ease-in-out">
