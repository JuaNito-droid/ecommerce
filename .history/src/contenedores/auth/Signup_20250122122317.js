  ...
  return (
    <Layout>
      ...
      <div className="w-[23%] bg-gradient-to-r from-crimson-red via-deep-rose via-dark-burgundy via-royal-purple to-midnight-blue rounded-l-lg rounded-tr-[18px] rounded-br-[18px]"></div>
        ...
        <div className="bg-white shadow-md border border-gray-200 rounded-lg w-full max-w-lg">

          <div className="w-1/4 bg-gradient-to-b from-crimson-red to-royal-purple rounded-l-lg sm:rounded-bl-lg"></div>
