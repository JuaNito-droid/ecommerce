    ...
    groupedCategories.length > 1 ? (
      ...
      <li key={firstWord} className="relative group">
        <div className="flex items-center h-5 my-5">
          <span className="text-gray-900 font-bold cursor-pointer">{firstWord}</span>
        </div>
        <ul className="absolute left-0 hidden group-hover:block bg-white border border-gray-200 shadow-md rounded-md">
