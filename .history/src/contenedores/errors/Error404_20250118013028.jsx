  ...
  return (
    <Layout>
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-700 to-pink-500 text-white">
        ...
        {/* Animación flotante */}
        <div className="absolute bottom-0 left-0 right-0 text-center py-8 text-gray-300">
            
          <p className="animate__animated animate__fadeIn animate__delay-2s mt-6">Creado con ❤️ por tu equipo de desarrollo</p>
        </div>
      </div>
    </Layout>
  );
