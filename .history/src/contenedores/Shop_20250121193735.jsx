...
const Shop = ({
    ...
    useEffect(() => {
        ...
        get_products();
        window.scrollTo(0, 0);
    }, [get_categories, get_products, get_brands]);
                            ...
                            <form onSubmit={onSubmit} className="hidden lg:block">
                                ...
                                groupedCategories.length > 1 ? (
                                    ...
                                    <div className="flex items-center h-5 my-5">
                                        ...
                                        <input
    type="radio"
    className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded-full opacity-0 absolute"
/>
<label className="ml-5 font-normal">{firstWord}</label>
