  ...
  {categories && Object.entries(
    ...
    groupedCategories.length > 1 ? (
      <li key={firstWord} className="relative group">
        ...
        {/* Menú desplegable */}
        <ul className="absolute left-0 w-full bg-white border border-gray-200 shadow-md rounded-md z-10 opacity-0 scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100">
