                ...
                {categories && Object.entries(
                  ...
                  groupedCategories.length > 1 ? (
                    <li key={firstWord} className="relative group">
                      ...
                      <ul className="absolute left-0 w-full bg-white border border-gray-200 shadow-md rounded-md z-10 opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100 group-hover:block hover:block">
