              ...
              <form onSubmit={e=>onSubmit(e)} className="hidden lg:block">
                ...
                {categories && Object.entries(
                  ...
                  groupedCategories.length > 1 ? (
                    // Menú desplegable para categorías que comparten la misma primera palabra
                    <li key={firstWord} className="relative group">
                      <div className="flex items-center h-2 my-5">
                        <input
                          name="category_id"
                          type="radio"
                          value={firstWord} // Usamos la primera palabra como el valor
                          className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded-full"
                      ...
                      {/* Menú desplegable con un área expandida para evitar que el ratón lo pierda */}
                      <ul className="absolute left-0 w-full bg-white border border-gray-200 shadow-md rounded-md z-10 opacity-0 scale-95 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100 group-hover:block hover:block">
                    ...
                    // Categoría única: seleccionable directamente
