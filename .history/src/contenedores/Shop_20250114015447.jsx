...
const Shop = ({
  ...
  const showProducts = () => {
    ...
    const limitedProducts = productsToDisplay.slice(startIndex, startIndex + productsPerPage);
    ...
    for (let i = 0; i < display.length; i += 4) {
      results.push(
        <div key={i} className="grid md:grid-cols-4 gap-2">
          <div className="mb-4">{display[i] || <div className=""></div>}</div>
          <div className="mb-4">{display[i + 1] || <div className=""></div>}</div>
          <div className="mb-4">{display[i + 2] || <div className=""></div>}</div>
          <div className="mb-4">{display[i + 3] || <div className=""></div>}</div>
        </div>
      );
    }
