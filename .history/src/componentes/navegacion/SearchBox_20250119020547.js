...
const SearchBox = ({ categories, search, onChange, onSubmit }) => {
  return (
    <form
      ...
      className="flex items-center border border-sky-haze rounded-md shadow-md overflow-hidden w-full max-w-3xl mx-auto"
    >
      ...
      <div className="relative">
        <select
          ...
          name="category_id"
          className="h-full text-sm text-gray-700 bg-sky-haze border-r border-purple-night px-4 py-2 outline-none focus:ring-deep-rose"
        >
