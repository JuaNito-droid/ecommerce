                    ...
                    <div className="mt-4 sm:mt-0 sm:pr-9">
                        <form onSubmit={onSubmit}>
                            <select
                                ...
                                onChange={onChange}
                                value={itemCount}
                                className="max-w-full rounded-md border border-gray-300 py-1.5 text-base leading-5 font-medium text-gray-700 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-midnight-blue focus:border-midnight-blue sm:text-sm"
                            >
