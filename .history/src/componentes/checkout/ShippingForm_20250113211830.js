          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">{shipping && shipping_id !== 0 ? <>Bs{shipping_cost}</>:<div className="text-red-500">(Please select shipping option)</div>}</dd>
              </div>
