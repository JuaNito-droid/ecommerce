...
const ShippingForm = ({
    ...
    return (
        <section
            ...
            className="mt-16 bg-gray-200 rounded-lg px-4 py-6 sm:p-6 lg:p-8 lg:mt-0 lg:col-span-5"
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">Bs{estimated_tax}</dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">Bs{total_compare_amount}</dd>
              </div>

              {
                  ...
                  <>
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                        ...
                        <dd className="text-sm font-medium text-gray-900">Bs{total_after_coupon}</dd>
                    </div>
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                        <dt className="text-base font-medium text-gray-900">Total del pedido</dt>
                        <dd className="text-base font-medium text-gray-900">Bs{total_amount}</dd>
                    </div>
                    </>
                        :
                    <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
