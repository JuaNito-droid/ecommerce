...
function ProductsArrival({ data, isAuthenticated }) {
  ...
  const settings = {
    ...
    speed: 1500, // Velocidad de deslizamiento
    ...
    prevArrow: (
      <button className="slick-prev absolute left-4 top-1/2 transform -translate-y-1/2 text-3xl text-gray-600 hover:text-gray-900">
        &lt;
      </button>
    ),
    nextArrow: (
      <button className="slick-next absolute right-4 top-1/2 transform -translate-y-1/2 text-3xl text-gray-600 hover:text-gray-900">
        &gt;
      </button>
    ),
  };
