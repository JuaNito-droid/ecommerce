...
import { HandRaisedIcon, RocketLaunchIcon, Cog6ToothIcon } from "@heroicons/react/24/outline";
  ...
  return (
    <div className="flex justify-around items-center bg-white py-10">
      ...
      <div className="flex flex-col items-center text-center">
        <HandRaisedIcon className="h-12 w-12 text-gray-700" />
      ...
      {/* Segunda tarjeta */}
      <div className="flex flex-col items-center text-center">
        <RocketLaunchIcon className="h-12 w-12 text-gray-700" />
      ...
      {/* Tercera tarjeta */}
      <div className="flex flex-col items-center text-center">
        <Cog6ToothIcon className="h-12 w-12 text-gray-700" />
