...
import { getBrands } from '../../redux/actions/brands'; // Asegúrate que esta acción esté bien configurada.
...
const Brand = () => {
    ...
    useEffect(() => {
        dispatch(getBrands()); // Despacha la acción para obtener las marcas
    }, [dispatch]);
