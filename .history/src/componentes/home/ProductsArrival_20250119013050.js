    ...
    responsive: [
      {
        breakpoint: 1024,
        settings: {
          slidesToShow: 2, // Mostrar 2 productos en pantallas de 1024px o menos
        },
      },
      {
        breakpoint: 768,
        settings: {
          slidesToShow: 2, // Mostrar 2 productos en pantallas de 768px o menos
        },
      },
    ],
    prevArrow: (
      <button className="slick-prev absolute left-4 top-1/2 transform -translate-y-1/2 text-xl text-gray-600 hover:text-gray-900">
        <ChevronLeftIcon className="w-8 h-8" />
      </button>
    ),
    nextArrow: (
      <button className="slick-next absolute right-4 top-1/2 transform -translate-y-1/2 text-xl text-gray-600 hover:text-gray-900">
