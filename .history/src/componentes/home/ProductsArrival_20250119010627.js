...
function ProductsArrival({ 
  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-16 -mt-28">
        <div className="py-8">
          <div className="py-8">
            <h2
              ref={headingRef}
        ...
        <div className="mt-2 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-3 lg:grid-cols-5 xl:gap-x-12">
          {data &&
            data !== null &&
            data !== undefined &&
            data.map((product) => (
