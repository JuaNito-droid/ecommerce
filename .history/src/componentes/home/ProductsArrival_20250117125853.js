  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 -mt-28">
        ...
        <div className="mt-2 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-12">
          {data &&
            data !== null &&
            data !== undefined &&
            data.map((product) => (
              <div key={product.id} className="group relative">
                ...
                <div className="mt-5 flex justify-between">
                  ...
                  {/* Mostrar el precio o el mensaje según la autenticación */}
                  {isAuthenticated ? (
...
const mapStateToProps = (state) => ({
  isAuthenticated: state.Auth.isAuthenticated, // Asegúrate de que `Auth` sea tu reducer con `isAuthenticated`
});
