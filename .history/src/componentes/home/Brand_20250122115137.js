...
const Brand = ({ brands, get_brands }) => {
  ...
  const [maxLength, setMaxLength] = useState(window.innerWidth >= 1024 ? 90 : 35);
  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 -mt-28">
        <div className="py-8">
          <h2 ref={headingRef} className="text-2xl font-extrabold tracking-tight text-gray-900 relative inline-block">
            Marcas
          </h2>
