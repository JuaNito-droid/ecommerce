  ...
  return (
    <div className="bg-white py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-32">
        <h2 className="text-center text-2xl font-bold text-gray-800 mb-6">Marcas</h2>
            ...
            brands.map((brand) => (
              ...
              >
                <img
                  src={brand.logo}
                  alt={brand.name}
                  className="w-full h-18 object-contain p-4 transition-transform duration-300 group-hover:scale-110"
                />
