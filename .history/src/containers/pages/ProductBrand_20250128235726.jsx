  ...
  return (
    <div className="bg-white py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-32">
        <h2 className="text-3xl font-bold text-gray-800 mb-18">Marcas</h2>
        
        {/* Contenedor responsivo para las letras */}
        <div className="flex justify-center overflow-x-auto whitespace-nowrap space-x-2 pb-2 mb-6">
          <button
            onClick={() => setSelectedLetter("ALL")}
            className={`px-3 py-1 rounded-md ${selectedLetter === "ALL" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800"}`}
          >
            Todas
          </button>
          {letters.map((letter) => (
