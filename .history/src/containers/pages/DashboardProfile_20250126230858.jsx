          ...
          <main className="flex-1">
            ...
            <form onSubmit={e => onSubmit(e)} className="max-w-3xl mx-auto">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <div className="max-w-lg flex rounded-md shadow-sm">
                    <input
                      ...
                      className="flex-1 block w-full min-w-0 rounded-md sm:text-sm border-2 border-gray-300 bg-gray-100 px-2 py-1"
                    />
                  </div>
                </div>
              ...
              >
                ...
                type="submit"
                className="inline-flex mt-4 float-right items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-midnight-blue hover:bg-purple-night focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Guardar
              </button>}
